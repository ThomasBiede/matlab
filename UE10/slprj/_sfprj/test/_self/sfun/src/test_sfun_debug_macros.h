 ...
 (double)dMax,ssid,offset,length)
	...
	v1,v2,\
	v3,_sfTime_,1)
	#define _SFD_CCP_CALL(v1,v3,v4,v5,v6) sf_debug_call(sfGlobalDebugInstanceStruct, _testMachineNumber_,\
	CHARTINSTANCE_CHARTNUMBER,\
	CHARTINSTANCE_INSTANCENUMBER,\
	...
	#define CV_TESTOBJECTIVE_EVAL(v1,v2,v3,v4)  cv_eval_testobjective(sfGlobalDebugInstanceStruct, _testMachineNumber_,\
			  ...
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v1),(v2),(v3),(v4))
	#define CV_ASSIGNMENT_EVAL(v2,v3,v4,v5)  cv_eval_assignment(sfGlobalDebugInstanceStruct, _testMachineNumber_,\
			  CHARTINSTANCE_CHARTNUMBER,\
			  CHARTINSTANCE_INSTANCENUMBER,\
			  (v2),(v3),(v4),(v5))
	...
	#define _SFD_CV_INIT_STATE_ASSIGNMENT(v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13)\
	     sf_debug_cv_init_assignment(sfGlobalDebugInstanceStruct, _testMachineNumber_,\
		  CHARTINSTANCE_CHARTNUMBER,\
		  CHARTINSTANCE_INSTANCENUMBER,\
