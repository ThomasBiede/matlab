...
static const char * c2_debug_family_names[4] = { "nargin", "nargout", "img",
  "out" };
...
static void c2_b_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance, const
  mxArray *c2_c_out, const char_T *c2_identifier, real32_T c2_b_y[921600]);
static void c2_c_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance, const
  mxArray *c2_c_u, const emlrtMsgIdentifier *c2_parentId, real32_T c2_b_y[921600]);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_testInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", *chartInstance->c2_b_out, 1, 0U, 1U,
    0U, 2, 720, 1280), false);
  ...
  mxArray *c2_st)
{
  ...
  c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_c_u, 0)),
                        "out", chartInstance->c2_fv0);
  for (c2_i0 = 0; c2_i0 < 921600; c2_i0++) {
    (*chartInstance->c2_b_out)[c2_i0] = chartInstance->c2_fv0[c2_i0];
  }

  chartInstance->c2_is_active_c2_test = c2_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_c_u, 1)), "is_active_c2_test");
...
static void sf_gateway_c2_test(SFc2_testInstanceStruct *chartInstance)
{
  ...
  for (c2_i1 = 0; c2_i1 < 2764800; c2_i1++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c2_b_img)[c2_i1], 0U);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  for (c2_i2 = 0; c2_i2 < 2764800; c2_i2++) {
    chartInstance->c2_img[c2_i2] = (*chartInstance->c2_b_img)[c2_i2];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(chartInstance->c2_img, 2U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(chartInstance->c2_out, 3U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 2);
  for (c2_i3 = 0; c2_i3 < 2764800; c2_i3++) {
    chartInstance->c2_X[c2_i3] = chartInstance->c2_img[c2_i3];
  }

  for (c2_i4 = 0; c2_i4 < 921600; c2_i4++) {
    chartInstance->c2_outputImage[c2_i4] = chartInstance->c2_out[c2_i4];
  }

  for (c2_i5 = 0; c2_i5 < 921600; c2_i5++) {
    chartInstance->c2_out[c2_i5] = chartInstance->c2_outputImage[c2_i5];
  }

  rgb2gray_tbb_real32(chartInstance->c2_X, 921600.0, chartInstance->c2_out, true);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -2);
  _SFD_SYMBOL_SCOPE_POP();
  for (c2_i6 = 0; c2_i6 < 921600; c2_i6++) {
    (*chartInstance->c2_b_out)[c2_i6] = chartInstance->c2_out[c2_i6];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  for (c2_i7 = 0; c2_i7 < 921600; c2_i7++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c2_b_out)[c2_i7], 1U);
  }
}
  ...
  *c2_inData)
{
  ...
  for (c2_i9 = 0; c2_i9 < 3; c2_i9++) {
    c2_i10 = 0;
    for (c2_i11 = 0; c2_i11 < 1280; c2_i11++) {
      for (c2_i12 = 0; c2_i12 < 720; c2_i12++) {
        chartInstance->c2_u[(c2_i12 + c2_i10) + c2_i8] = (*(real32_T (*)[2764800])
          c2_inData)[(c2_i12 + c2_i10) + c2_i8];
      }
  ...
  *c2_inData)
{
  ...
  c2_mxArrayOutData = NULL;
  c2_i13 = 0;
  for (c2_i14 = 0; c2_i14 < 1280; c2_i14++) {
    for (c2_i15 = 0; c2_i15 < 720; c2_i15++) {
      chartInstance->c2_b_u[c2_i15 + c2_i13] = (*(real32_T (*)[921600])c2_inData)
        [c2_i15 + c2_i13];
    }
  ...
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", chartInstance->c2_b_u, 1, 0U, 1U, 0U,
    2, 720, 1280), false);
  sf_mex_assign(&c2_mxArrayOutData, c2_b_y, false);
  return c2_mxArrayOutData;
}
  ...
  mxArray *c2_c_out, const char_T *c2_identifier, real32_T c2_b_y[921600])
{
  ...
  c2_thisId.fParent = NULL;
  c2_thisId.bParentIsCell = false;
  c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_c_out), &c2_thisId, c2_b_y);
...
{
  int32_T c2_i16;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_c_u), chartInstance->c2_fv1, 1, 1, 0U,
                1, 0U, 2, 720, 1280);
  for (c2_i16 = 0; c2_i16 < 921600; c2_i16++) {
    c2_b_y[c2_i16] = chartInstance->c2_fv1[c2_i16];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  c2_thisId.fParent = NULL;
  c2_thisId.bParentIsCell = false;
  c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_c_out), &c2_thisId,
                        chartInstance->c2_y);
  sf_mex_destroy(&c2_c_out);
  c2_i17 = 0;
  for (c2_i18 = 0; c2_i18 < 1280; c2_i18++) {
    for (c2_i19 = 0; c2_i19 < 720; c2_i19++) {
      (*(real32_T (*)[921600])c2_outData)[c2_i19 + c2_i17] = chartInstance->
        c2_y[c2_i19 + c2_i17];
    }
  ...
  const mxArray *c2_c_u, const emlrtMsgIdentifier *c2_parentId)
{
  ...
  int32_T c2_i20;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_c_u), &c2_i20, 1, 6, 0U, 0, 0U, 0);
  c2_b_y = c2_i20;
  sf_mex_destroy(&c2_c_u);
  return c2_b_y;
}
...
static void init_simulink_io_address(SFc2_testInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_b_img = (real32_T (*)[2764800])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_b_out = (real32_T (*)[921600])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3815124212U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2426875501U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2114405273U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1675351299U);
}
...
mxArray *sf_c2_test_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("qnbzaZkfJid1lh2tXC2MXC");
...
mxArray *sf_c2_test_jit_fallback_info(void)
{
  ...
  mxArray *incompatibleSymbol = mxCreateString("rgb2gray_tbb_real32");
...
static const mxArray *sf_get_sim_state_info_c2_test(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[8],M[0],T\"is_active_c2_test\",}}"
  };
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"img");
...
static void chart_debug_initialize_data_addresses(SimStruct *S)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      ...
      {
        _SFD_SET_DATA_VALUE_PTR(0U, (void *)chartInstance->c2_b_img);
        _SFD_SET_DATA_VALUE_PTR(1U, (void *)chartInstance->c2_b_out);
      }
    }
  }
}
...
{
  return "s6pIHSxzdvAXW2tekLMtEIF";
}
...
static void mdlSetWorkWidths_c2_test(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(370476921U));
  ssSetChecksum1(S,(438480638U));
  ssSetChecksum2(S,(1277683726U));
  ssSetChecksum3(S,(3002292805U));
